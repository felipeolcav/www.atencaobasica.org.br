...
$bannedWords = array( 'merda','caralho','filho da puta','idiota','foda' );
$bannedUserIPs = array(  );
$bannedUserIDs = array();
$bannedMessage = 'Você foi banido por usar palavras inapropriadas. Suas mensagens não serão enviadas.';
...
define('ADMIN_USER','comunidadedepraticas');
define('ADMIN_PASS','ce232454');
...
$barWidth = '360';			// If set to fixed, enter the width of the bar in pixels
$barAlign = 'right';			// If set to fixed, enter alignment of the bar
