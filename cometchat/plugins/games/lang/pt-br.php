...
$games_language[0] = 'Jogar um jogo';
$games_language[1] = 'Por favor selecione um jogo';
$games_language[2] = 'Qual jogo gostaria de jogar?';
$games_language[3] = 'lhe enviou uma solicitação de jogo.';
$games_language[4] = 'Clique aqui para aceita-la';
$games_language[5] = ' ou simplesmente ignore essa mensagem.';
$games_language[6] = 'enviou uma solicitação de jogo com sucesso.';
$games_language[7] = 'Solicitação de Jogo enviada!';
$games_language[8] = 'Qual jogo gostaria de jogar?';
$games_language[9] = 'Usuário enviou solicitação de jogo com sucesso. Você deve recebe uma resposta em breve. Fechando janela.';
$games_language[10] = 'aceitou sua solicitação de jogo.';
$games_language[11] = 'Clique aqui para abrir a janela do jogo.';
$games_language[12] = 'Jogando Jogo!';
